...
CardinfoPage = __decorate([
    ...
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
        selector: 'page-cardinfo',template:/*ion-inline-start:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/cardinfo/cardinfo.html"*/'<!--\n  Generated template for the CardinfoPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="gongdan-color" class="nav_bar">\n    <ion-title>客户</ion-title>\n   <ion-buttons end>\n      <button ion-button icon-only tappable (click)="takePhoto()">\n        <p>添加</p>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/cardinfo/cardinfo.html"*/,
    }),
...
CardinfoPageModule = cardinfo_module___decorate([
    cardinfo_module___WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        ...
        imports: [
            cardinfo_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(CardinfoPage),
        ],
        exports: [
            CardinfoPage
        ]
