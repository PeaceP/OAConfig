...
var VisitListPage = (function () {
    function VisitListPage(navCtrl, navParams, statusBar, datePicker, storage, writejournalService, toastCtrl) {
        ...
        this.storage.get('user')
            ...
            _this.writejournalService.get_visit_list(bodyone).then(function (res) {
...
VisitListPageModule = visit_list_module___decorate([
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(VisitListPage),
        ],
    })
], VisitListPageModule);
