...
// CONCATENATED MODULE: ./src/pages/work-bench/gongdan/create-gongdan/biaoqian/biaoqian-auto.ts
...
var CreateBiaoQianAutoService = (function () {
    function CreateBiaoQianAutoService(http) {
        this.http = http;
        this.labelAttribute = "name";
    }
    CreateBiaoQianAutoService.prototype.getResults = function (keyword) {
    ...
    return CreateBiaoQianAutoService;
}());
CreateBiaoQianAutoService = __decorate([
    __WEBPACK_IMPORTED_MODULE_1__angular_core__["Injectable"](),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_http__["b" /* Http */]])
], CreateBiaoQianAutoService);

//# sourceMappingURL=biaoqian-auto.js.map
// CONCATENATED MODULE: ./src/pages/work-bench/gongdan/create-gongdan/biaoqian/biaoqian.ts
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__gongdanService__ = __webpack_require__(701);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_Utils__ = __webpack_require__(238);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_status_bar__ = __webpack_require__(67);
var biaoqian___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var biaoqian___metadata = (this && this.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
var BiaoqianPage = (function () {
    function BiaoqianPage(navCtrl, navParams, gongdanService, createBiaoQianAutoService, statusbar) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.gongdanService = gongdanService;
        this.createBiaoQianAutoService = createBiaoQianAutoService;
        ...
        if (this.need_pop_reback) {
            this.frontPage = __WEBPACK_IMPORTED_MODULE_6__providers_Utils__["a" /* Utils */].getViewController("RebackGongdanPage", navCtrl);
        }
        else {
            this.frontPage = __WEBPACK_IMPORTED_MODULE_6__providers_Utils__["a" /* Utils */].getViewController("CreateGongdanPage", navCtrl);
        }
        this.gongdanService.get_all_biaoqian().then(function (res) {
            if (res.result && res.result.res_code == 1) {
                _this.list = res.result.res_data;
                _this.brand_list = _this.list.brand_list.res_data;
                _this.category_list = _this.list.category_list.res_data;
                _this.area_list = _this.list.area_list.res_data;
                _this.brand_select_ids = _this.brand_list;
                _this.area_select_ids = _this.area_list;
                _this.cate_select_ids = _this.category_list;
                for (var _i = 0, _a = _this.brand_select_ids; _i < _a.length; _i++) {
                    var items = _a[_i];
                    for (var _b = 0, _c = _this.brand_list; _b < _c.length; _b++) {
                        var items_in = _c[_b];
                        if (items == items_in.id) {
                            _this.chooseList.push(items_in);
                            items_in.ischeck = true;
                            _this.brand_list[_this.brand_list.indexOf(items_in)] = items_in;
                        }
                    }
                }
                for (var _d = 0, _e = _this.area_select_ids; _d < _e.length; _d++) {
                    var items = _e[_d];
                    for (var _f = 0, _g = _this.area_list; _f < _g.length; _f++) {
                        var items_in = _g[_f];
                        if (items == items_in.id) {
                            _this.chooseList.push(items_in);
                            items_in.ischeck = true;
                            _this.area_list[_this.area_list.indexOf(items_in)] = items_in;
                        }
                    }
                }
                for (var _h = 0, _j = _this.cate_select_ids; _h < _j.length; _h++) {
                    var items = _j[_h];
                    for (var _k = 0, _l = _this.category_list; _k < _l.length; _k++) {
                        var items_in = _l[_k];
                        if (items == items_in.id) {
                            _this.chooseList.push(items_in);
                            items_in.ischeck = true;
                            _this.category_list[_this.category_list.indexOf(items_in)] = items_in;
                        }
                    }
                }
            }
    ...
    BiaoqianPage.prototype.ionViewWillEnter = function () {
        this.statusbar.backgroundColorByHexString("#2597ec");
        this.statusbar.styleLightContent();
    };
    BiaoqianPage.prototype.chooseBrandItem = function (item) {
    ...
    BiaoqianPage.prototype.chooseAreaItem = function (item) {
        item.ischeck = !item.ischeck;
        if (item.ischeck) {
    ...
    BiaoqianPage.prototype.chooseCategoryItem = function (item) {
        item.ischeck = !item.ischeck;
        if (item.ischeck) {
    ...
    BiaoqianPage.prototype.itemSelected = function (event) {
        var _this = this;
        var search_type;
        var search_text;
        if (event.id == 1) {
        ...
        this.gongdanService.search_biaoqian(search_type, search_text).then(function (res) {
            if (res.result.res_data && res.result.res_code == 1) {
                ...
                if (res.result.res_data.type == "category") {
                    _this.category_list = res.result.res_data.data.res_data;
                    for (var _i = 0, _a = _this.cate_select_ids; _i < _a.length; _i++) {
                        var items = _a[_i];
                        for (var _b = 0, _c = _this.category_list; _b < _c.length; _b++) {
                            var items_in = _c[_b];
                            if (items == items_in.id) {
                                items_in.ischeck = true;
                                _this.category_list[_this.category_list.indexOf(items_in)] = items_in;
                ...
                if (res.result.res_data.type == "brand") {
                    _this.brand_list = res.result.res_data.data.res_data;
                    for (var _d = 0, _e = _this.brand_select_ids; _d < _e.length; _d++) {
                        var items = _e[_d];
                        for (var _f = 0, _g = _this.brand_list; _f < _g.length; _f++) {
                            var items_in = _g[_f];
                            if (items == items_in.id) {
                                items_in.ischeck = true;
                                _this.brand_list[_this.brand_list.indexOf(items_in)] = items_in;
                ...
                if (res.result.res_data.type == "area") {
                    _this.area_list = res.result.res_data.data.res_data;
                    for (var _h = 0, _j = _this.area_select_ids; _h < _j.length; _h++) {
                        var items = _j[_h];
                        for (var _k = 0, _l = _this.area_list; _k < _l.length; _k++) {
                            var items_in = _l[_k];
                            if (items == items_in.id) {
                                items_in.ischeck = true;
                                _this.area_list[_this.area_list.indexOf(items_in)] = items_in;
    ...
    BiaoqianPage.prototype.cancel_biaoqian = function () {
        for (var _i = 0, _a = this.brand_select_ids; _i < _a.length; _i++) {
            var items = _a[_i];
            for (var _b = 0, _c = this.brand_list; _b < _c.length; _b++) {
                var items_in = _c[_b];
                if (items == items_in.id) {
        ...
        for (var _d = 0, _e = this.cate_select_ids; _d < _e.length; _d++) {
            var items = _e[_d];
            for (var _f = 0, _g = this.category_list; _f < _g.length; _f++) {
                var items_in = _g[_f];
                if (items == items_in.id) {
                    items_in.ischeck = false;
        ...
        for (var _h = 0, _j = this.area_select_ids; _h < _j.length; _h++) {
            var items = _j[_h];
            for (var _k = 0, _l = this.area_list; _k < _l.length; _k++) {
                var items_in = _l[_k];
                if (items == items_in.id) {
                    items_in.ischeck = false;
    ...
    BiaoqianPage.prototype.confirm_biaoqian = function () {
    ...
    BiaoqianPage.prototype.goBack = function () {
    ...
    BiaoqianPage.prototype.all_tag = function () {
        var _this = this;
        this.brand_list = [];
        this.area_list = [];
        this.category_list = [];
        this.gongdanService.get_all_biaoqian().then(function (res) {
            ...
            if (res.result.res_data && res.result.res_code == 1) {
                if (res.result.res_data.brand_list) {
                    _this.brand_list = res.result.res_data.brand_list.res_data;
                    for (var _i = 0, _a = _this.brand_select_ids; _i < _a.length; _i++) {
                        var items = _a[_i];
                        for (var _b = 0, _c = _this.brand_list; _b < _c.length; _b++) {
                            var items_in = _c[_b];
                ...
                if (res.result.res_data.area_list) {
                    _this.area_list = res.result.res_data.area_list.res_data;
                    for (var _d = 0, _e = _this.area_select_ids; _d < _e.length; _d++) {
                        var items = _e[_d];
                        for (var _f = 0, _g = _this.area_list; _f < _g.length; _f++) {
                            var items_in = _g[_f];
                ...
                if (res.result.res_data.category_list) {
                    _this.category_list = res.result.res_data.category_list.res_data;
                    for (var _h = 0, _j = _this.cate_select_ids; _h < _j.length; _h++) {
                        var items = _j[_h];
                        for (var _k = 0, _l = _this.category_list; _k < _l.length; _k++) {
                            var items_in = _l[_k];
...
BiaoqianPage = biaoqian___decorate([
    __WEBPACK_IMPORTED_MODULE_1_ionic_angular_navigation_ionic_page__["a" /* IonicPage */](),
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
        selector: 'page-biaoqian',template:/*ion-inline-start:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/gongdan/create-gongdan/biaoqian/biaoqian.html"*/'<!--\n  Generated template for the BiaoqianPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar hideBackButton="true" color="gongdan-color">\n    <ion-buttons left>\n      <button ion-button icon-only (click)="goBack()">\n        <ion-icon name="close"></ion-icon>\n      </button>\n    </ion-buttons>\n    <ion-title>标签</ion-title>\n    <ion-buttons end>\n      <button ion-button (click)=\'all_tag()\'>\n        所有标签\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <div style="justify-content:space-around">\n    <span round style=\'background-color:#f5a623;flex :1 1 100%\' *ngFor="let item of chooseList"  ion-button>\n      {{item.name}}\n    </span>\n  </div>\n    <ion-auto-complete style="width: 94vw;margin-left:3vw" (itemSelected) = "itemSelected($event)"  [dataProvider]="createBiaoQianAutoService"></ion-auto-complete>\n\n  <div style="background:#e4e5e6;padding:4px;padding-left:10px">\n    品牌\n  </div>\n\n  <ion-list>\n    <ion-item *ngFor="let item of brand_list;let i = index">\n      <ion-label> {{item.name}}</ion-label>\n      <ion-checkbox (click)="chooseBrandItem(item)" [checked]=item.ischeck></ion-checkbox>\n    </ion-item>\n  </ion-list>\n\n\n  <div style="background:#e4e5e6;padding:4px;padding-left:10px">\n    部门\n  </div>\n\n  <ion-list>\n    <ion-item *ngFor="let item of area_list;let i = index">\n      <ion-label> {{item.name}}</ion-label>\n      <ion-checkbox (click)="chooseAreaItem(item)" [checked]=item.ischeck></ion-checkbox>\n    </ion-item>\n  </ion-list>\n\n  <div style="background:#e4e5e6;padding:4px;padding-left:10px">\n    产品\n  </div>\n\n  <ion-list>\n    <ion-item *ngFor="let item of category_list;let i = index">\n      <ion-label> {{item.name}}</ion-label>\n      <ion-checkbox (click)="chooseCategoryItem(item)" [checked]=item.ischeck></ion-checkbox>\n    </ion-item>\n  </ion-list>\n\n\n</ion-content>\n\n<ion-footer >\n          <div style="background:white">\n    <span align="center" style=\'width:50%;float:left; background-color:#fba958;height:44px;line-height:44px;font-size:15px;color:white\' tappable (click)="cancel_biaoqian()">\n      重置\n    </span>\n    <span align="center" style=\'width:50%;float:right;background-color:#1eabfe;height:44px;line-height:44px;font-size:15px;color:white\' tappable (click)="confirm_biaoqian()">\n      确定\n    </span>\n  </div>\n</ion-footer>\n'/*ion-inline-end:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/gongdan/create-gongdan/biaoqian/biaoqian.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_4__gongdanService__["a" /* GongDanService */], CreateBiaoQianAutoService]
    }),
    biaoqian___metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular_navigation_nav_controller__["a" /* NavController */], __WEBPACK_IMPORTED_MODULE_3_ionic_angular_navigation_nav_params__["a" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_4__gongdanService__["a" /* GongDanService */], CreateBiaoQianAutoService,
        __WEBPACK_IMPORTED_MODULE_7__ionic_native_status_bar__["a" /* StatusBar */]])
], BiaoqianPage);

//# sourceMappingURL=biaoqian.js.map
// CONCATENATED MODULE: ./src/pages/work-bench/gongdan/create-gongdan/biaoqian/biaoqian.module.ts
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BiaoqianPageModule", function() { return BiaoqianPageModule; });
/* harmony import */ var biaoqian_module___WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic2_auto_complete__ = __webpack_require__(700);
var biaoqian_module___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
...
BiaoqianPageModule = biaoqian_module___decorate([
    biaoqian_module___WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        declarations: [
            BiaoqianPage,
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(BiaoqianPage), __WEBPACK_IMPORTED_MODULE_3_ionic2_auto_complete__["a" /* AutoCompleteModule */]
        ],
    })
], BiaoqianPageModule);

//# sourceMappingURL=biaoqian.module.js.map
