...
// CONCATENATED MODULE: ./src/pages/work-bench/gongdan/gongdan-choose-people/gongdan-choose-people.ts
 ...
 */
var GongdanChoosePeoplePage = (function () {
    function GongdanChoosePeoplePage(navCtrl, navParams, gongDanService, toast, statusbar) {
        var _this = this;
    ...
    GongdanChoosePeoplePage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad GongdanChoosePeoplePage');
    };
    GongdanChoosePeoplePage.prototype.ionViewWillEnter = function () {
        this.statusbar.backgroundColorByHexString("#2597ec");
        this.statusbar.styleLightContent();
    };
    GongdanChoosePeoplePage.prototype.itemSelect = function (item) {
        var is_has = false;
        this.select_list.splice(0, 1);
        this.select_list.push(item.user_id);
    };
    GongdanChoosePeoplePage.prototype.is_select = function (item) {
        var is_has = false;
    ...
    GongdanChoosePeoplePage.prototype.getItems = function (ev) {
    ...
    GongdanChoosePeoplePage.prototype.confirm = function () {
        console.log(this.select_list);
        if (!this.select_list[0]) {
            __WEBPACK_IMPORTED_MODULE_4__providers_Utils__["a" /* Utils */].toastButtom("请选择@的人", this.toast);
        }
        else {
            // this.select_list[0]
            if (this.select_name) {
    ...
    return GongdanChoosePeoplePage;
}());
GongdanChoosePeoplePage = __decorate([
    __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPage */](),
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
        selector: 'page-gongdan-choose-people',template:/*ion-inline-start:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/gongdan/gongdan-choose-people/gongdan-choose-people.html"*/'<!--\n  Generated template for the GongdanChoosePeoplePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="gongdan-color">\n    <ion-title>选择@的人</ion-title>\n    <ion-buttons end>\n      <button ion-button (click)=\'confirm()\'>\n        确定\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n    <ion-searchbar placeholder = "搜索" (ionInput)="getItems($event)"></ion-searchbar>\n    <div style="overflow:scroll;margin-top:2px;">\n    <ion-list>\n      <ion-item tappable (click) = "itemSelect(item)" *ngFor = \'let item of employeeList\'>\n        <ion-avatar item-start>\n            <img src={{item.image}}>\n        </ion-avatar>\n        <h2>{{item.name}}</h2>\n        <p>{{item.job_id.name}}</p>\n        <img *ngIf="is_select(item)" item-end style="float:right;width:18px;" src="assets/img/work_bench/checkbox_true.png">\n      </ion-item>\n  </ion-list>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/gongdan/gongdan-choose-people/gongdan-choose-people.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_3__gongdanService__["a" /* GongDanService */]]
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__gongdanService__["a" /* GongDanService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["B" /* ToastController */],
        __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */]])
], GongdanChoosePeoplePage);

//# sourceMappingURL=gongdan-choose-people.js.map
// CONCATENATED MODULE: ./src/pages/work-bench/gongdan/gongdan-choose-people/gongdan-choose-people.module.ts
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GongdanChoosePeoplePageModule", function() { return GongdanChoosePeoplePageModule; });
/* harmony import */ var gongdan_choose_people_module___WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var gongdan_choose_people_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
var gongdan_choose_people_module___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var GongdanChoosePeoplePageModule = (function () {
    function GongdanChoosePeoplePageModule() {
    }
    return GongdanChoosePeoplePageModule;
}());
GongdanChoosePeoplePageModule = gongdan_choose_people_module___decorate([
    gongdan_choose_people_module___WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        declarations: [
            GongdanChoosePeoplePage,
        ],
        imports: [
            gongdan_choose_people_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(GongdanChoosePeoplePage),
        ],
    })
], GongdanChoosePeoplePageModule);

//# sourceMappingURL=gongdan-choose-people.module.js.map
