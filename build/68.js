...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__writejournalService__ = __webpack_require__(838);
...
var JournalSheetPage = (function () {
    ...
    JournalSheetPage.prototype.ionViewWillEnter = function () {
        ...
        this.storage.get('user')
            ...
            _this.writejournalService.get_visit_list(body).then(function (res) {
                if (res.result.res_code == 1 && res.result) {
                    console.log(res);
...
JournalSheetPageModule = journal_sheet_module___decorate([
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(JournalSheetPage),
        ],
    })
