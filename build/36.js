...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__add_employee_EmployeeService__ = __webpack_require__(707);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__contact_persionService__ = __webpack_require__(712);
...
var ContactPersonPage = (function () {
    function ContactPersonPage(navCtrl, navParams, contactService, employeeService, storage, statusbar) {
        ...
        this.limit = 20;
        this.offset = 0;
        this.contactService.get_departments().then(function (res) {
            if (res.result && res.result.res_code == 1) {
                _this.departmentList = res.result.res_data;
            }
        });
...
ContactPersonPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["u" /* NavController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["v" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__contact_persionService__["a" /* ContactService */],
...
ContactPersonPageModule = contact_person_module___decorate([
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(ContactPersonPage),
        ],
        exports: [
            ContactPersonPage
        ]
