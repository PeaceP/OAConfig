...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__choose_ChooseService__ = __webpack_require__(708);
...
ProductlistPage = __decorate([
    ...
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
        selector: 'page-productlist',template:/*ion-inline-start:"/Users/bin/Downloads/MyOA 2/src/pages/customer/productlist/productlist.html"*/'<ion-header>\n  <ion-navbar color="gongdan-color">\n    <ion-title>\n      感兴趣的产品\n    </ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only tappable (click)="save_series()">\n        <p>保存</p>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n  \n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <ion-item style="height:60px" *ngFor="let item of arr ; let i = index">  \n        <ion-label>{{item.name}}</ion-label>\n        <ion-checkbox tappable style="margin-left:-10px;" (ionChange)="insertUserToArray(item)" [checked]="isCheck(item) ? true : false"></ion-checkbox>\n     </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/bin/Downloads/MyOA 2/src/pages/customer/productlist/productlist.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_2__choose_ChooseService__["a" /* ChooseService */]],
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__choose_ChooseService__["a" /* ChooseService */]])
], ProductlistPage);
...
ProductlistPageModule = productlist_module___decorate([
    productlist_module___WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        ...
        imports: [
            productlist_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(ProductlistPage),
        ],
        exports: [
            ProductlistPage
        ]
