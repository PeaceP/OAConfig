...
// CONCATENATED MODULE: ./src/pages/work-bench/shengoupage/edit-add-shengou/edit-add-shengou.ts
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shengouService__ = __webpack_require__(706);
 ...
 */
var EditAddShengouPage = (function () {
    function EditAddShengouPage(navCtrl, navParams, shenGouService, alertCtrl, toastCtrl, platform) {
        var _this = this;
        ...
        this.mShenGoupage = __WEBPACK_IMPORTED_MODULE_3__providers_Utils__["a" /* Utils */].getViewController("EditNewShengouPage", navCtrl);
    ...
    EditAddShengouPage.prototype.ionViewWillLeave = function () {
        if (this.platform.is('ios')) {
            cordova.plugins.Keyboard.close();
        }
    };
    EditAddShengouPage.prototype.panEvent = function ($event) {
        if (this.platform.is('ios')) {
            cordova.plugins.Keyboard.close();
        }
    };
    EditAddShengouPage.prototype.ionViewDidEnter = function () {
    ...
    EditAddShengouPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad EditAddShengouPage');
    };
    EditAddShengouPage.prototype.goBack = function () {
        var _this = this;
    ...
    EditAddShengouPage.prototype.save = function () {
        var mString = "";
    ...
    return EditAddShengouPage;
}());
EditAddShengouPage = __decorate([
    __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPage */](),
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
        selector: 'page-edit-add-shengou',template:/*ion-inline-start:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/shengoupage/edit-add-shengou/edit-add-shengou.html"*/'<!--\n  Generated template for the AddApplyDetailPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar color="gongdan-color" hideBackButton="true">\n    <ion-buttons left>\n      <button ion-button icon-only (click)="goBack()">\n        <ion-icon ios="ios-arrow-back" md="md-arrow-back"></ion-icon>\n      </button>\n    </ion-buttons>\n    <ion-title>申购明细</ion-title>\n    <ion-buttons end>\n      <button ion-button (click)=\'save()\'>\n        确定\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content (pan)="panEvent($event)">\n\n  <ion-item>\n    <ion-label style="color:black">产品</ion-label>\n    <ion-select [(ngModel)]="productIndex" class="normal-select">\n      <ion-option *ngFor="let item of productList;let i = index;" >{{item.name}}</ion-option>\n    </ion-select>\n  </ion-item>\n  <ion-item>\n    <ion-label style="color:black">单价 (元)\n    </ion-label>\n    <ion-input  #mNumberCon  item-end  text-wrap type="number" text-right [(ngModel)]="amount"></ion-input>\n  </ion-item>\n\n  <ion-item>\n    <ion-label style="color:black">数量\n    </ion-label>\n    <ion-input  #mNumberCon  item-end  text-wrap type="number" text-right [(ngModel)]="unit"></ion-input>\n  </ion-item>\n\n  <ion-item no-lines>\n\n    <ion-label>申购说明</ion-label>\n\n  </ion-item>\n  <ion-item>\n    <ion-textarea  rows = "15"  text-wrap placeholder=\'请输入申购明细描述\'  [(ngModel)]="remark" class=\'area_class\' >\n    </ion-textarea>\n  </ion-item>\n\n</ion-content>\n'/*ion-inline-end:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/shengoupage/edit-add-shengou/edit-add-shengou.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_2__shengouService__["a" /* ShenGouService */]]
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__shengouService__["a" /* ShenGouService */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["B" /* ToastController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["x" /* Platform */]])
], EditAddShengouPage);

//# sourceMappingURL=edit-add-shengou.js.map
// CONCATENATED MODULE: ./src/pages/work-bench/shengoupage/edit-add-shengou/edit-add-shengou.module.ts
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditAddShengouPageModule", function() { return EditAddShengouPageModule; });
/* harmony import */ var edit_add_shengou_module___WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var edit_add_shengou_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
var edit_add_shengou_module___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var EditAddShengouPageModule = (function () {
    function EditAddShengouPageModule() {
    }
    return EditAddShengouPageModule;
}());
EditAddShengouPageModule = edit_add_shengou_module___decorate([
    edit_add_shengou_module___WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        declarations: [
            EditAddShengouPage,
        ],
        imports: [
            edit_add_shengou_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(EditAddShengouPage),
        ],
    })
], EditAddShengouPageModule);

//# sourceMappingURL=edit-add-shengou.module.js.map
