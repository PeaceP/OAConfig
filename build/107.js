...
WuliuDetailPage = __decorate([
    ...
    __WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"]({
        selector: 'page-wuliu-detail',template:/*ion-inline-start:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/salesOrder/jiaohuo-list/wuliu-detail/wuliu-detail.html"*/'<!--\n  Generated template for the WuliuDetailPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="gongdan-color">\n    <ion-title>{{item.name}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <div *ngIf="details.length==0" style="text-align:center"> \n    没有物流信息\n  </div>\n  <ion-list>\n    <ion-item *ngFor="let detail of details">\n      <div style="margin-top:20px">\n          <div style="text-align:center">\n              {{detail.create_date}}\n            </div>\n            <img  style="margin-top:20px"  src={{detail.local_url}}>\n      </div>\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/salesOrder/jiaohuo-list/wuliu-detail/wuliu-detail.html"*/,
    }),
...
WuliuDetailPageModule = wuliu_detail_module___decorate([
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(WuliuDetailPage),
        ],
    })
