...
// CONCATENATED MODULE: ./src/pages/add-employee/employee-detail/employee-detail.ts
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__me_edit_information_editInformationService__ = __webpack_require__(844);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_Utils__ = __webpack_require__(238);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_NativeService__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__EmployeeService__ = __webpack_require__(707);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ionic_angular_components_action_sheet_action_sheet_controller__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_in_app_browser__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ionic_angular_components_alert_alert_controller__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_app_availability__ = __webpack_require__(836);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_call_number__ = __webpack_require__(705);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_storage__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_moment__ = __webpack_require__(699);
...
var EmployeeDetailPage = (function () {
    function EmployeeDetailPage(navCtrl, navParams, callNumber, alertCtrl, toast, appAvailability, platform, editInformationService, actionSheetCtrl, nativeService, employeeService, toastCtrl, datePipe, storage) {
        var _this = this;
        ...
        this.show_type = "one";
        this.sexList = [{ name: '男', id: 'male' }, { name: '女', id: 'female' }];
        this.marriageList = [{ name: '单身', id: 'single' }, { name: '已婚', id: 'married' }, { name: '离异', id: 'divorced' }, { name: '丧偶', id: 'widower' }];
        this.shiyongList = [{ name: '半个月', id: 'half_month' }, { name: '一个月', id: 'one_month' }, { name: '两个月', id: 'two_month' },
            { name: '三个月', id: 'three_month' }, { name: '无', id: '' }];
        this.mining_productivity_list = [{ name: '实习', id: 'practice_work' }, { name: '派遣', id: 'dispatch_work' },
            { name: '试用', id: 'try_out_work' }, { name: '正式', id: 'fixed_work' }, { name: '离职', id: 'leaving_work' },];
        this.isModify = false;
        this.isDeletePicture = false;
        this.origin_email = "";
        this.origin_identification_id = "";
        this.isShowEdit = false;
        this.isCanSeeAll = false;
        this.employeeService.get_employee_list().then(function (res) {
            if (res.result.res_data && res.result.res_code == 1) {
                _this.minzuList = res.result.res_data;
            }
        });
        this.employeeService.getDepartmentNoLoading().then(function (res) {
            if (res.result.res_data && res.result.res_code == 1) {
    ...
    EmployeeDetailPage.prototype.panEvent = function ($event) {
        cordova.plugins.Keyboard.close();
    };
    EmployeeDetailPage.prototype.checkIsCanSeeAll = function () {
        for (var i = 0; i < __WEBPACK_IMPORTED_MODULE_0__providers_HttpService__["a" /* HttpService */].user.employee_all_child.length; i++) {
            if (this.item.id == __WEBPACK_IMPORTED_MODULE_0__providers_HttpService__["a" /* HttpService */].user.employee_all_child[i]) {
        ...
        if (this.item.uid == __WEBPACK_IMPORTED_MODULE_0__providers_HttpService__["a" /* HttpService */].user_id) {
            this.isCanSeeAll = true;
        }
    };
    ...
    EmployeeDetailPage.prototype.ionViewWillEnter = function () {
    ...
    EmployeeDetailPage.prototype.click_one = function () {
        this.show_type = "one";
    };
    EmployeeDetailPage.prototype.click_two = function () {
        this.show_type = "two";
    };
    EmployeeDetailPage.prototype.click_three = function () {
        this.show_type = "three";
    };
    EmployeeDetailPage.prototype.callPhone = function () {
        var _this = this;
        ...
        if (this.item.mobile_phone != 'false' && this.item.mobile_phone != '') {
            var confirm_1 = this.alertCtrl.create({
                ...
                buttons: [
                    ...
                    },
                    {
                        text: '确定',
                        handler: function () {
                            _this.call(_this.item.mobile_phone);
                        }
                    }
                ]
            }).present();
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_Utils__["a" /* Utils */].toastButtom("该员工未填写手机号", this.toast);
        }
    };
    EmployeeDetailPage.prototype.call = function (number) {
        this.callNumber.callNumber(number, true)
            .then(function () { return console.log('Launched dialer!'); })
            .catch(function () { return console.log('Error launching dialer'); });
    };
    EmployeeDetailPage.prototype.sendEmail = function () {
        this.openAppWith('alicloudmail://', 'com.alibaba.cloudmail');
    };
    EmployeeDetailPage.prototype.openAppWith = function (ios_bundle_id, android_bundle_id) {
        var app;
        ...
        this.appAvailability.check(app).then(function () {
            var browser = new __WEBPACK_IMPORTED_MODULE_7__ionic_native_in_app_browser__["a" /* InAppBrowser */]();
    ...
    EmployeeDetailPage.prototype.edit = function () {
        this.isModify = true;
    };
    EmployeeDetailPage.prototype.release = function () {
        var _this = this;
        this.item.entry_date;
        if (this.item.entry_date > this.datePipe.transform(new Date(), 'yyyy-MM-dd')) {
            __WEBPACK_IMPORTED_MODULE_3__providers_Utils__["a" /* Utils */].toastButtom("入职日期不可超过今天", this.toastCtrl);
            return;
        }
        var mString = "";
        if (!this.item.name) {
        ...
        if (mString != "") {
            ...
            if (this.item.certificate_image_ids) {
                for (var i = 0; i < this.item.certificate_image_ids.length; i++) {
                    var img = this.item.certificate_image_ids[i];
            ...
            var push_identification_id = void 0;
            ...
            var upDate_item = {
                ...
                edit_id: __WEBPACK_IMPORTED_MODULE_0__providers_HttpService__["a" /* HttpService */].user_id,
            ...
            this.employeeService.update_employee(upDate_item).then(function (res) {
                if (res.result.res_data && res.result.res_code == 1) {
                        ...
                        buttons: [
                            {
                                ...
                                handler: function () {
                                    ...
                                    _this.origin_email = _this.item.work_email;
                                    _this.origin_identification_id = _this.item.identification_id;
                                }
                            }
                        ]
                    }).present();
    ...
    EmployeeDetailPage.prototype.changeHeardImg = function () {
        this.photoType = "heard";
        this.addImg(true);
    };
    EmployeeDetailPage.prototype.addImg = function (allowEdit) {
        var _this = this;
    ...
    EmployeeDetailPage.prototype.getPicture = function (type, allowEdit) {
        var _this = this;
        if (allowEdit === void 0) { allowEdit = false; }
        var options = {
            allowEdit: allowEdit,
    ...
    EmployeeDetailPage.prototype.getPictureSuccess = function (img_url) {
    ...
    // 拍摄正面
    EmployeeDetailPage.prototype.takePositive = function () {
        this.addImg();
        this.photoType = "photoPositive";
    };
    // 拍摄反面
    EmployeeDetailPage.prototype.takeNegative = function () {
        this.addImg();
        this.photoType = "photoNeagtive";
    };
    // 银行卡照片
    EmployeeDetailPage.prototype.takeBankPhoto = function () {
        this.addImg();
        this.photoType = "photoBank";
    };
    // 证书照片
    EmployeeDetailPage.prototype.takeZhengshuPhoto = function () {
        this.addImg();
        this.photoType = "photoZhengshu";
    };
    EmployeeDetailPage.prototype.clickPositivePicture = function (item) {
        this.photoType = "photoPositive";
        this.clickPicture(item);
    };
    EmployeeDetailPage.prototype.clickNeagtivePicture = function (item) {
        this.photoType = "photoNeagtive";
        this.clickPicture(item);
    };
    EmployeeDetailPage.prototype.clickBankPicture = function (item) {
        this.photoType = "photoBank";
        this.clickPicture(item);
    };
    EmployeeDetailPage.prototype.clickZhengshuPicture = function (item) {
        this.photoType = "photoZhengshu";
        this.clickPicture(item);
    };
    EmployeeDetailPage.prototype.clickPicture = function (item) {
        this.deletePicture = item;
        this.navCtrl.push("DeletePicturePage", { item: item, EmployeeDetailPage: "EmployeeDetailPage" });
    };
    EmployeeDetailPage.prototype.watch = function (item) {
        if (this.item.entry_date && this.item.probation_period_id) {
            var d = __WEBPACK_IMPORTED_MODULE_14_moment__(this.item.entry_date, "YYYY-MM-DD");
            var endDate = void 0;
    ...
    EmployeeDetailPage.prototype.cancel = function () {
        var _this = this;
        var self = this;
        this.alertCtrl.create({
            ...
            buttons: [
                { text: '取消' },
                {
                    text: '确定',
                    handler: function () {
                        _this.employeeService.get_employee_info([_this.item.id], false).then(function (res) {
                            console.log(res);
    ...
    EmployeeDetailPage.prototype.goBack = function () {
        var ContactPersonPage = __WEBPACK_IMPORTED_MODULE_3__providers_Utils__["a" /* Utils */].getViewController("ContactPersonPage", this.navCtrl);
...
EmployeeDetailPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_12_ionic_angular__["u" /* NavController */],
        ...
        __WEBPACK_IMPORTED_MODULE_5__EmployeeService__["a" /* EmployeeService */],
        __WEBPACK_IMPORTED_MODULE_12_ionic_angular__["B" /* ToastController */],
...
// CONCATENATED MODULE: ./src/pages/add-employee/employee-detail/employee-detail.module.ts
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ionic_img_viewer__ = __webpack_require__(244);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(20);
var employee_detail_module___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var EmployeeDetailPageModule = (function () {
    function EmployeeDetailPageModule() {
    }
    return EmployeeDetailPageModule;
}());
EmployeeDetailPageModule = employee_detail_module___decorate([
    __WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"]({
        declarations: [
            EmployeeDetailPage,
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["q" /* IonicPageModule */].forChild(EmployeeDetailPage), __WEBPACK_IMPORTED_MODULE_0_ionic_img_viewer__["a" /* IonicImageViewerModule */]
        ],
    })
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(846)(module)))
...
;(function (global, factory) {
    true ? factory(__webpack_require__(699)) :
