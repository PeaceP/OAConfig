...
IncomingDetailPageModule = incoming_detail_module___decorate([
    incoming_detail_module___WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        ...
        imports: [
            incoming_detail_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(IncomingDetailPage),
        ],
        exports: [
            IncomingDetailPage
        ]
