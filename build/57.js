...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__order_orderService__ = __webpack_require__(704);
 ...
 */
var ReturnProductDetailPage = (function () {
    function ReturnProductDetailPage(navCtrl, navParams, orderservice) {
    ...
    ReturnProductDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ReturnProductDetailPage');
    };
    ReturnProductDetailPage.prototype.pushToDetail = function () {
        var _this = this;
    ...
    return ReturnProductDetailPage;
}());
ReturnProductDetailPage = __decorate([
    __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPage */](),
    __WEBPACK_IMPORTED_MODULE_2__angular_core__["Component"]({
        selector: 'page-return-product-detail',template:/*ion-inline-start:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/return-order-detail/return-product-detail/return-product-detail.html"*/'<!--\n  Generated template for the ProductDetailPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="gongdan-color">\n    <ion-title>详情</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <div>\n    <ion-item class="div_all" (click)="pushToDetail()">\n      <div text-wrap class="div_right" style="color:#04aaf4"> {{item.name}} </div>\n      <div class="left_label,div_left" style="color:#04aaf4;margin-top:0px" text-right> 产品 </div>\n    </ion-item>\n    <div class="div_all">\n      <div text-wrap class="div_right"> {{item.invoice_status[1]}} </div>\n      <div class="left_label,div_left" text-right> 对账状态 </div>\n    </div>\n\n    <div class="div_all">\n      <div text-wrap class="div_right"> {{item.product_uom_qty}} </div>\n      <div class="left_label,div_left" text-right> 退货数量 </div>\n    </div>\n\n    <div class="div_all">\n      <div text-wrap class="div_right"> {{item.qty_delivered}} </div>\n      <div class="left_label,div_left" text-right> 收到数量 </div>\n    </div>\n\n    <div class="div_all">\n      <div text-wrap class="div_right"> {{item.qty_to_invoice}} </div>\n      <div class="left_label,div_left" text-right> 待对账数量 </div>\n    </div>\n\n    <div class="div_all">\n      <div text-wrap class="div_right"> {{item.uom}} </div>\n      <div class="left_label,div_left" text-right> 计量单位 </div>\n    </div>\n\n    <div class="div_all">\n      <div text-wrap class="div_right"> {{item.price_unit}} </div>\n      <div class="left_label,div_left" text-right> 单价 </div>\n    </div>\n\n    <div class="div_all">\n      <div text-wrap class="div_right"> {{item.price_subtotal}} </div>\n      <div class="left_label,div_left" text-right>小计 </div>\n    </div>\n\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/return-order-detail/return-product-detail/return-product-detail.html"*/,
...
//# sourceMappingURL=return-product-detail.js.map
// CONCATENATED MODULE: ./src/pages/work-bench/return-order-detail/return-product-detail/return-product-detail.module.ts
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReturnProductDetailPageModule", function() { return ReturnProductDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var return_product_detail_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
var return_product_detail_module___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var ReturnProductDetailPageModule = (function () {
    function ReturnProductDetailPageModule() {
    }
    return ReturnProductDetailPageModule;
}());
ReturnProductDetailPageModule = return_product_detail_module___decorate([
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        declarations: [
            ReturnProductDetailPage,
        ],
        imports: [
            return_product_detail_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(ReturnProductDetailPage),
        ],
    })
], ReturnProductDetailPageModule);

//# sourceMappingURL=return-product-detail.module.js.map
