...
NewDeletePage = __decorate([
    ...
    __WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"]({
        selector: 'page-new-delete',template:/*ion-inline-start:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/journal-sheet/new-delete/new-delete.html"*/'<!--\n  Generated template for the NewDeletePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="titleBlack">\n    <ion-title></ion-title>\n    <ion-buttons end>\n        <button ion-button icon-only   (click)=\'delete()\'>\n            <ion-icon name="close"></ion-icon>\n        </button>\n      </ion-buttons>\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n<ion-content padding style="background:black">\n\n  <img src={{item}}>\n\n</ion-content>\n'/*ion-inline-end:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/journal-sheet/new-delete/new-delete.html"*/,
    }),
...
NewDeletePageModule = new_delete_module___decorate([
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(NewDeletePage),
        ],
    })
], NewDeletePageModule);
