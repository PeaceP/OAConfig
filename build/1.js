...
// CONCATENATED MODULE: ./src/pages/add-employee/add-employee.ts
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular_components_alert_alert_controller__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_Utils__ = __webpack_require__(238);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic_angular_components_action_sheet_action_sheet_controller__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_NativeService__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ionic_angular_navigation_nav_params__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_ionic_angular_navigation_nav_controller__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ionic_angular_navigation_ionic_page__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__EmployeeService__ = __webpack_require__(707);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_moment__ = __webpack_require__(699);
...
var AddEmployeePage = (function () {
    function AddEmployeePage(navCtrl, nativeService, actionSheetCtrl, navParams, toastCtrl, datePipe, alertCtrl, employeeService) {
        var _this = this;
        ...
        this.shiyongList = [{ name: '半个月', id: 'half_month' }, { name: '一个月', id: 'one_month' }, { name: '二个月', id: 'two_month' },
        ...
        this.employeeService.get_employee_list().then(function (res) {
            if (res.result.res_data && res.result.res_code == 1) {
                ...
                for (var i = 0; i < _this.minzuList.length; i++) {
                    if (_this.minzuList[i].name == "汉族") {
                        _this.nation = _this.minzuList[i].id;
                    }
                }
            }
        });
        ...
        this.entry_date = __WEBPACK_IMPORTED_MODULE_3__providers_Utils__["a" /* Utils */].dateFormat(new Date(), 'yyyy-MM-dd');
    }
    AddEmployeePage.prototype.ionViewWillEnter = function () {
    ...
    AddEmployeePage.prototype.panEvent = function ($event) {
        cordova.plugins.Keyboard.close();
    };
    // 拍摄正面
    AddEmployeePage.prototype.takePositive = function () {
        this.addImg();
        this.photoType = "photoPositive";
    };
    // 拍摄反面
    AddEmployeePage.prototype.takeNegative = function () {
        this.addImg();
        this.photoType = "photoNeagtive";
    };
    // 银行卡照片
    AddEmployeePage.prototype.takeBankPhoto = function () {
        this.addImg();
        this.photoType = "photoBank";
    };
    // 证书照片
    AddEmployeePage.prototype.takeZhengshuPhoto = function () {
        this.addImg();
        this.photoType = "photoZhengshu";
    };
    AddEmployeePage.prototype.clickPositivePicture = function (item) {
        this.photoType = "photoPositive";
        this.clickPicture(item);
    };
    AddEmployeePage.prototype.clickNeagtivePicture = function (item) {
        this.photoType = "photoNeagtive";
        this.clickPicture(item);
    };
    AddEmployeePage.prototype.clickBankPicture = function (item) {
        this.photoType = "photoBank";
        this.clickPicture(item);
    };
    AddEmployeePage.prototype.clickZhengshuPicture = function (item) {
        this.photoType = "photoZhengshu";
        this.clickPicture(item);
    };
    AddEmployeePage.prototype.watch = function (item) {
        if (this.entry_date && this.probation_period) {
            var d = __WEBPACK_IMPORTED_MODULE_12_moment__(this.entry_date, "YYYY-MM-DD");
            var endDate = void 0;
    ...
    AddEmployeePage.prototype.addImg = function (allowEdit) {
        var _this = this;
    ...
    AddEmployeePage.prototype.getPicture = function (type, allowEdit) {
        var _this = this;
        if (allowEdit === void 0) { allowEdit = false; }
        var options = {
            allowEdit: false,
    ...
    AddEmployeePage.prototype.changeHeardImg = function () {
        this.photoType = "heard";
        this.addImg(true);
    };
    AddEmployeePage.prototype.getPictureSuccess = function (img_url) {
    ...
    AddEmployeePage.prototype.goBack = function () {
        var _this = this;
    ...
    AddEmployeePage.prototype.next = function () {
    ...
    AddEmployeePage.prototype.clickPicture = function (item) {
        this.deletePicture = item;
        this.navCtrl.push("DeletePicturePage", { item: item, AddEmployeePage: "AddEmployeePage" });
    };
    AddEmployeePage.prototype.isTelCode = function (str) {
        var reg = /^[1][0-9]{10}$/;
        return reg.test(str);
    };
    AddEmployeePage.prototype.isShenFenCode = function (str) {
...
AddEmployeePage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_7_ionic_angular_navigation_nav_controller__["a" /* NavController */],
        ...
        __WEBPACK_IMPORTED_MODULE_11_ionic_angular__["B" /* ToastController */],
        ...
        __WEBPACK_IMPORTED_MODULE_10__EmployeeService__["a" /* EmployeeService */]])
], AddEmployeePage);

//# sourceMappingURL=add-employee.js.map
// CONCATENATED MODULE: ./src/pages/add-employee/add-employee.module.ts
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_angular2_qrcode__ = __webpack_require__(247);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_img_viewer__ = __webpack_require__(244);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic_angular__ = __webpack_require__(20);
var add_employee_module___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
...
AddEmployeePageModule = add_employee_module___decorate([
    __WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"]({
        declarations: [
            AddEmployeePage,
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["q" /* IonicPageModule */].forChild(AddEmployeePage), __WEBPACK_IMPORTED_MODULE_1_ionic_img_viewer__["a" /* IonicImageViewerModule */], __WEBPACK_IMPORTED_MODULE_0_angular2_qrcode__["a" /* QRCodeModule */]
        ],
    })
