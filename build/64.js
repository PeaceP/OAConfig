...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__kaoqinService__ = __webpack_require__(710);
...
var KaoqinPage = (function () {
    function KaoqinPage(navCtrl, navParams, storage, kaoqinService, datePipe, ble, toastCtrl, loading, elementRef, alertCtrl, platform) {
        var _this = this;
        ...
        this.platform.ready().then(function () {
            console.log("123");
            WifiWizard.startScan(function successNetwork(ss) {
                console.log(ss);
                alert(ss);
                WifiWizard.getScanResults(function listHandler(e) {
                    alert(e);
                });
            }, function failNetWork(ee) {
                console.log(ee);
            });
        });
...
KaoqinPageModule = kaoqin_module___decorate([
    kaoqin_module___WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(KaoqinPage), __WEBPACK_IMPORTED_MODULE_3_ionic_img_viewer__["a" /* IonicImageViewerModule */]
        ],
    })
], KaoqinPageModule);
