...
MoreLevelListPage = __decorate([
    ...
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
        selector: 'page-more-level-list',template:/*ion-inline-start:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/new-production/more-level-list/more-level-list.html"*/'<!--\n  Generated template for the MoreLevelListPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="gongdan-color">\n    <ion-title>{{title}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <ion-list>\n    <ion-item tappable *ngFor="let items of item" (click)="itemClick(items)">\n      <p style="color:black;float:left;">{{items.name}}</p>\n      <p *ngIf="items.child_id.length > 0" style="float:right">></p> \n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/new-production/more-level-list/more-level-list.html"*/,
...
MoreLevelListPageModule = more_level_list_module___decorate([
    more_level_list_module___WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        ...
        imports: [
            more_level_list_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(MoreLevelListPage),
        ],
    })
