...
// CONCATENATED MODULE: ./src/pages/work-bench/salesOrder/create-quotes/production-list/production-list.ts
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_barcode_scanner__ = __webpack_require__(246);
 ...
 */
var ProductionListPage = (function () {
    function ProductionListPage(navCtrl, navParams, barcodeScanner, salesSearvice) {
        ...
        this.offset = 0;
        this.mAddProductionPage = __WEBPACK_IMPORTED_MODULE_0__providers_Utils__["a" /* Utils */].getViewController("AddProductionPage", navCtrl);
    }
    ProductionListPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ProductionListPage');
        this.addData();
    };
    ProductionListPage.prototype.addData = function () {
        var _this = this;
    ...
    ProductionListPage.prototype.doRefresh = function (refresh) {
        var _this = this;
        this.isMoreData = true;
        this.limit = 20;
        this.offset = 0;
    ...
    ProductionListPage.prototype.doInfinite = function (infiniteScroll) {
        var _this = this;
        if (this.isMoreData == true) {
            this.limit = 20;
            this.offset = this.offset + 20;
            this.salesSearvice.getProducts(this.offset, this.limit).then(function (res) {
    ...
    ProductionListPage.prototype.updateCucumber = function (i) {
        var self = this;
        self.mAddProductionPage.data.productionItem = this.items[i];
        this.navCtrl.pop();
    };
    ProductionListPage.prototype.searchClick = function () {
        var _this = this;
    ...
    ProductionListPage.prototype.scan = function () {
        var _this = this;
        var self = this;
        this.barcodeScanner.scan().then(function (barcodeData) {
            // Success! Barcode data is here
            console.log(barcodeData);
            _this.salesSearvice.searchProductionByScan(barcodeData.text).then(function (res) {
                console.log(res);
...
ProductionListPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3_ionic_angular__["u" /* NavController */], __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["v" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_4__ionic_native_barcode_scanner__["a" /* BarcodeScanner */], __WEBPACK_IMPORTED_MODULE_1__salesService__["a" /* SalesSearvice */]])
], ProductionListPage);

//# sourceMappingURL=production-list.js.map
// CONCATENATED MODULE: ./src/pages/work-bench/salesOrder/create-quotes/production-list/production-list.module.ts
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProductionListPageModule", function() { return ProductionListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
var production_list_module___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var ProductionListPageModule = (function () {
    function ProductionListPageModule() {
    }
    return ProductionListPageModule;
}());
ProductionListPageModule = production_list_module___decorate([
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        declarations: [
            ProductionListPage,
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(ProductionListPage),
        ],
        exports: [
            ProductionListPage
        ]
    })
], ProductionListPageModule);

//# sourceMappingURL=production-list.module.js.map
