...
WarehouseMovePage = __decorate([
    ...
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
        selector: 'page-warehouse-move',template:/*ion-inline-start:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/production-search/production-detail/warehouse-move/warehouse-move.html"*/'<!--\n  Generated template for the WarehouseMovePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="gongdan-color">\n    <ion-title>库存移动</ion-title>\n  </ion-navbar>\n  <ion-grid >\n      <ion-row>\n        <ion-col col-4>\n          产品名\n        </ion-col>\n        <ion-col col-2>\n          数量\n        </ion-col>\n        <ion-col col-3>\n          来源位置\n        </ion-col>\n        <ion-col col-3>\n          目的位置\n        </ion-col>\n      </ion-row>\n    </ion-grid>\n\n</ion-header>\n\n\n\n\n\n<ion-content >\n\n    <ion-list *ngFor="let item of items;let i =index">\n        <ion-grid >\n          <ion-row>\n            <ion-col col-4>\n              {{item.name}}\n            </ion-col>\n            <ion-col col-2>\n              {{item.product_uom_qty}}\n            </ion-col>\n            <ion-col col-3>\n              {{item.location}}\n            </ion-col>\n            <ion-col col-3>\n              {{item.location_dest}}\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n      </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/production-search/production-detail/warehouse-move/warehouse-move.html"*/,
    }),
...
WarehouseMovePageModule = warehouse_move_module___decorate([
    warehouse_move_module___WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        ...
        imports: [
            warehouse_move_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(WarehouseMovePage),
        ],
        exports: [
            WarehouseMovePage
        ]
