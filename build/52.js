...
// CONCATENATED MODULE: ./src/pages/work-bench/production-search/production-search.ts
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__salesOrder_salesService__ = __webpack_require__(703);
 ...
 */
var ProductionSearchPage = (function () {
    function ProductionSearchPage(navCtrl, navParams, barcodeScanner, salesSearvice) {
    ...
    ProductionSearchPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ProductionListPage');
        this.addData();
    };
    ProductionSearchPage.prototype.addData = function () {
        var _this = this;
    ...
    ProductionSearchPage.prototype.doRefresh = function (refresh) {
        var _this = this;
        this.isMoreData = true;
        this.limit = 20;
        this.offset = 0;
        this.salesSearvice.getProducts(0, 20).then(function (res) {
            console.log(res);
            refresh.complete();
            _this.items = res.result.res_data;
        });
    };
    ProductionSearchPage.prototype.doInfinite = function (infiniteScroll) {
        var _this = this;
        var self = this;
        if (this.isMoreData == true) {
            self.limit = 20;
            self.offset = self.offset + 20;
            this.salesSearvice.getProducts(self.offset, self.limit).then(function (res) {
    ...
    ProductionSearchPage.prototype.toDetail = function (index) {
        var _this = this;
        this.salesSearvice.getProductionDetailById(this.items[index].id).then(function (res) {
            if (res.result && res.result.res_code == 1) {
                _this.navCtrl.push('ProductionDetailPage', { item: res.result.res_data });
            }
        });
    };
    ProductionSearchPage.prototype.searchClick = function () {
        var _this = this;
    ...
    ProductionSearchPage.prototype.scan = function () {
        var _this = this;
        var self = this;
        this.barcodeScanner.scan().then(function (barcodeData) {
            // Success! Barcode data is here
            console.log(barcodeData);
            _this.salesSearvice.getProductionDetailByCode(barcodeData.text).then(function (res) {
                console.log(res);
                _this.navCtrl.push('ProductionDetailPage', { item: res.result.res_data });
            });
        }, function (err) {
    ...
    return ProductionSearchPage;
}());
ProductionSearchPage = __decorate([
    __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["p" /* IonicPage */](),
    __WEBPACK_IMPORTED_MODULE_2__angular_core__["Component"]({
        selector: 'page-production-search',template:/*ion-inline-start:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/production-search/production-search.html"*/'<!--\n  Generated template for the ProductionListPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n    \n      <ion-navbar color="gongdan-color">\n        <ion-title>产品</ion-title>\n        <ion-buttons end>\n          <button ion-button icon-only tappable (click)="scan()">\n              <ion-icon name="qr-scanner"></ion-icon>\n            </button>\n        </ion-buttons>\n    \n      </ion-navbar>\n      <ion-grid  class="searchBackground">\n          <ion-row>\n            <ion-col col-4>\n              内部参考\n            </ion-col>\n            <ion-col col-3>\n              内部类别\n            </ion-col>\n            <ion-col col-2.5>\n              在手数量\n            </ion-col>\n            <ion-col col-2.5>\n              预测数量\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n    \n    </ion-header>\n    \n    \n    <ion-content >\n      <div class="searchBackground">\n          <ion-grid >\n              <ion-row>\n                <ion-col col-6>\n                  <div>\n                    <ion-input [(ngModel)]="searchName" placeholder="输入产品名称" text-wrap style="margin-left:20px;;"></ion-input>\n                  </div>\n                </ion-col>\n                <ion-col col-6>\n                  <div><button (click)=\'searchClick()\' class="searchFont">搜索</button></div>\n                </ion-col>\n              </ion-row>\n            </ion-grid>\n      </div>\n      <ion-refresher (ionRefresh)="doRefresh($event)">\n        <ion-refresher-content></ion-refresher-content>\n      </ion-refresher>\n      <ion-list >\n        <ion-grid *ngFor="let item of items;let i =index" (click)="toDetail(i)">\n          <ion-row >\n            <ion-col col-4>\n              {{item.default_code}}\n            </ion-col>\n            <ion-col col-3>\n              {{item.categ_id}}\n            </ion-col>\n            <ion-col col-2.5>\n              {{item.qty_available}}\n            </ion-col>\n            <ion-col col-2.5>\n              {{item.virtual_qty}}\n            </ion-col>\n          </ion-row>\n          <div class="divLine"></div>\n        </ion-grid>\n      </ion-list>\n      <ion-infinite-scroll (ionInfinite)="doInfinite($event)">\n        <ion-infinite-scroll-content></ion-infinite-scroll-content>\n      </ion-infinite-scroll>\n    \n    </ion-content>\n    '/*ion-inline-end:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/production-search/production-search.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_0__salesOrder_salesService__["a" /* SalesSearvice */]]
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3_ionic_angular__["u" /* NavController */], __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["v" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_1__ionic_native_barcode_scanner__["a" /* BarcodeScanner */], __WEBPACK_IMPORTED_MODULE_0__salesOrder_salesService__["a" /* SalesSearvice */]])
], ProductionSearchPage);

//# sourceMappingURL=production-search.js.map
// CONCATENATED MODULE: ./src/pages/work-bench/production-search/production-search.module.ts
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProductionSearchPageModule", function() { return ProductionSearchPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
var production_search_module___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var ProductionSearchPageModule = (function () {
    function ProductionSearchPageModule() {
    }
    return ProductionSearchPageModule;
}());
ProductionSearchPageModule = production_search_module___decorate([
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        declarations: [
            ProductionSearchPage,
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(ProductionSearchPage)
        ],
        entryComponents: [],
        exports: [
            ProductionSearchPage,
...
], ProductionSearchPageModule);

//# sourceMappingURL=production-search.module.js.map
