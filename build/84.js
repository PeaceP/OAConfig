...
// CONCATENATED MODULE: ./src/pages/work-bench/create-apply/create-apply.ts
 ...
 */
var CreateApplyPage = (function () {
    function CreateApplyPage(navCtrl, navParams, commonService, storage) {
        var _this = this;
        ...
        this.storage.get('user')
            ...
            _this.getPaymentReminding(_this.user_id);
        });
    }
    CreateApplyPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad CreateApplyPage');
    };
    CreateApplyPage.prototype.getPaymentReminding = function (id) {
        var _this = this;
        this.commonService.getPaymentReminding(id)
            .then(function (res) {
            console.log(res);
            _this.dataBean = res.result.res_data;
            _this.name = res.result.res_data.name;
        });
    };
    return CreateApplyPage;
}());
CreateApplyPage = __decorate([
    __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPage */](),
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"]({
        selector: 'page-create-apply',template:/*ion-inline-start:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/create-apply/create-apply.html"*/'<!--\n  Generated template for the CreateApplyPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="gongdan-color">\n    <ion-title>新建报销</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <div>\n      <span>申请人</span>\n      <span>{{dataBean.name}}</span>\n  </div>\n  <div>\n      <span>部门（费用归属）</span>\n      <span>研发部</span>\n  </div>\n  <div>\n      <span>申请人</span>\n      <span>{{dataBean.pre_payment_reminding}}</span>\n  </div>\n  \n</ion-content>\n'/*ion-inline-end:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/create-apply/create-apply.html"*/,
        providers: [__WEBPACK_IMPORTED_MODULE_3__commonUseServices__["a" /* CommonUseServices */]],
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_3__commonUseServices__["a" /* CommonUseServices */], __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */]])
], CreateApplyPage);

//# sourceMappingURL=create-apply.js.map
// CONCATENATED MODULE: ./src/pages/work-bench/create-apply/create-apply.module.ts
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CreateApplyPageModule", function() { return CreateApplyPageModule; });
/* harmony import */ var create_apply_module___WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var create_apply_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
var create_apply_module___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var CreateApplyPageModule = (function () {
    function CreateApplyPageModule() {
    }
    return CreateApplyPageModule;
}());
CreateApplyPageModule = create_apply_module___decorate([
    create_apply_module___WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        declarations: [
            CreateApplyPage,
        ],
        imports: [
            create_apply_module___WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(CreateApplyPage),
        ],
    })
], CreateApplyPageModule);

//# sourceMappingURL=create-apply.module.js.map
