...
WaitMeApplyPage = __decorate([
    ...
    __WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"]({
        selector: 'page-wait-me-apply',template:/*ion-inline-start:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/reimbursement/wait-me-apply/wait-me-apply.html"*/'<!--\n  Generated template for the WaitMeApplyPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar color="gongdan-color">\n    <ion-title>报销详细</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>\n<ion-footer>\n  <button ion-button (click)="agree()" > 通过</button>\n  <button ion-button (click)="disagree()"> 不通过</button>\n</ion-footer>\n'/*ion-inline-end:"/Users/bin/Downloads/MyOA 2/src/pages/work-bench/reimbursement/wait-me-apply/wait-me-apply.html"*/,
    }),
...
WaitMeApplyPageModule = wait_me_apply_module___decorate([
    __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"]({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* IonicPageModule */].forChild(WaitMeApplyPage),
        ],
    })
